    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 overflow-y-auto flex items-center justify-center p-4 sm:p-6 bg-black/70 backdrop-blur-md">
        <motion.div
          ...
          className="relative w-full max-w-3xl bg-white rounded-3xl border border-[#E5D9C8] overflow-hidden shadow-2xl my-8 flex flex-col max-h-[90vh]"
        >
          {/* Header */}
          <div className="p-6 border-b border-[#EBE2D5] flex items-center justify-between bg-[#FAF7F2]">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-[#FAF5EE] border border-[#C59A5D] flex items-center justify-center">
                <Sparkles className="w-5 h-5 text-[#C59A5D]" />
              </div>
              <div>
                <h2 className="font-serif-display text-xl sm:text-2xl font-bold text-[#1E1B18]">
          ...
          <div className="overflow-y-auto p-6 sm:p-8">
            {isSubmitted ? (
              <div className="py-12 text-center max-w-md mx-auto space-y-5">
                <div className="w-16 h-16 rounded-full bg-[#FAF5EE] border-2 border-[#6B1724] text-[#6B1724] flex items-center justify-center mx-auto shadow-md">
                  <Check className="w-8 h-8" />
                </div>
                <h3 className="font-serif-display text-3xl font-bold text-[#1E1B18]">
                  Inquiry Received!
                </h3>
                <p className="text-xs sm:text-sm text-[#52453E] font-light leading-relaxed">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                {/* Notice Pill */}
                <div className="p-3.5 rounded-2xl bg-[#FAF5EE] border border-[#DFCDB7] flex items-center gap-2.5 text-xs text-[#6B1724]">
                  <Lock className="w-4 h-4 text-[#C59A5D] flex-shrink-0" />
                  <span>
                ...
                {/* Submit Actions */}
                <div className="pt-4 border-t border-[#EBE2D5] flex flex-col sm:flex-row items-center justify-between gap-3">
                  <button
                    type="button"
                    onClick={handleSendWhatsApp}
