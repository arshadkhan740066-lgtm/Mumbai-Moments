  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-black/60 backdrop-blur-sm overflow-y-auto">
      <motion.div
        ...
        className="bg-white border border-[#E8D9DC] w-full max-w-2xl rounded-3xl overflow-hidden my-auto max-h-[90vh] flex flex-col shadow-[0_20px_60px_rgba(0,0,0,0.2)]"
      >
        {/* Header */}
        <div className="p-6 bg-[#FFFDFB] border-b border-[#E8D9DC] flex items-center justify-between flex-shrink-0">
          <div className="flex items-center gap-2">
            <span className="w-2.5 h-2.5 rounded-full bg-[#8F3F50]" />
            <h3 className="font-serif-display text-2xl font-bold text-[#241E20]">
        ...
        {/* Modal Content */}
        <div className="p-6 sm:p-8 overflow-y-auto space-y-6 text-sm text-[#5C4E52] font-light leading-relaxed">
          {modalType === 'about' && (
            <div className="space-y-4">
              <p className="text-base text-[#8F3F50] font-serif-display italic">
              ...
              <div className="p-5 rounded-2xl bg-[#FFFDFB] border border-[#E8D9DC] space-y-2">
                <h4 className="text-xs uppercase tracking-wider font-bold text-[#8F3F50] flex items-center gap-2">
                  <Lock className="w-4 h-4 text-[#C9A15B]" />
          ...
          {modalType === 'contact' && (
            <div className="space-y-4">
              ...
              <div className="space-y-3 pt-2">
                <div className="p-5 rounded-2xl bg-[#FFFDFB] border border-[#E8D9DC] flex items-center gap-3">
                  <Phone className="w-5 h-5 text-[#C9A15B]" />
                  <div>
                    <div className="text-xs text-[#C9A15B] font-medium">WhatsApp & VIP Hotline</div>
                    <div className="text-sm font-bold text-[#241E20]">{BRANDING.contactPhone}</div>
                  </div>
                </div>
                <div className="p-5 rounded-2xl bg-[#FFFDFB] border border-[#E8D9DC] flex items-center gap-3">
                  <Mail className="w-5 h-5 text-[#C9A15B]" />
                  <div>
                    <div className="text-xs text-[#C9A15B] font-medium">Concierge Inquiries</div>
                    <div className="text-sm font-bold text-[#241E20]">{BRANDING.contactEmail}</div>
                  </div>
                </div>
                <div className="p-5 rounded-2xl bg-[#FFFDFB] border border-[#E8D9DC] flex items-center gap-3">
                  <Building2 className="w-5 h-5 text-[#C9A15B]" />
                  <div>
                    <div className="text-xs text-[#C9A15B] font-medium">The Private Estate Location</div>
                    <div className="text-sm font-bold text-[#241E20]">Pali Hill, Bandra West, Mumbai 400050</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          {modalType === 'editorial' && (
            <div className="space-y-4">
              <h4 className="text-xs uppercase tracking-wider font-bold text-[#8F3F50]">
                Our 4 Pillars of Bespoke Production
              </h4>
              <ol className="text-xs space-y-2 text-[#5C4E52] list-decimal list-inside">
          ...
          {modalType === 'faq' && (
            <div className="space-y-4">
              <div className="bg-[#FFFDFB] border border-[#E8D9DC] rounded-2xl p-4">
                <h4 className="font-serif-display text-base font-bold text-[#241E20] mb-1">
                  How many guests can attend?
                </h4>
                <p className="text-xs text-[#5C4E52] font-light">
          ...
          {modalType === 'privacy' && (
            <div className="space-y-3 text-xs text-[#5C4E52]">
              <p>
        ...
        {/* Footer */}
        <div className="p-4 sm:p-6 bg-[#FFFDFB] border-t border-[#E8D9DC] flex items-center justify-between flex-shrink-0">
          <button
            onClick={() => {
              onClose();
              onOpenInquiry();
          ...
          <button
            onClick={onClose}
            className="px-6 py-2 rounded-full aurawed-button-secondary text-[#8F3F50] text-xs font-bold uppercase tracking-wider cursor-pointer"
          >
            Close
          </button>
        </div>
