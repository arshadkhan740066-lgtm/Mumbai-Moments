...
export const LoveAIStudio: React.FC<LoveAIStudioProps> = ({
  ...
  return (
    <section id="love-ai-studio" className="py-20 bg-[#FAF7F2] border-b border-[#E5D9C8] relative overflow-hidden">
      {/* Background luxury elements */}
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#6B1724]/4 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-[#C59A5D]/8 rounded-full blur-3xl pointer-events-none" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        {/* Section Header */}
        <div className="text-center max-w-3xl mx-auto mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#FAF0E1] border border-[#DFCDB7] text-[#6B1724] text-xs font-semibold uppercase tracking-widest mb-3 shadow-xs">
            <Sparkles className="w-3.5 h-3.5 text-[#C59A5D]" />
            <span>Aura Love AI™ Concierge</span>
          </div>

          <h2 className="font-serif-display text-3xl sm:text-5xl font-bold text-[#1E1B18] tracking-tight mb-4">
            Love AI Automation Suite
          </h2>

          <p className="text-sm sm:text-base text-[#52453E] font-light leading-relaxed">
          ...
          {/* Navigation Tabs */}
          <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3 mt-8 p-1.5 bg-[#F0E6D8] rounded-full max-w-2xl mx-auto border border-[#E0D2C0]">
            <button
              ...
              className={`flex-1 py-2.5 px-3.5 rounded-full text-xs font-semibold tracking-wider transition-all flex items-center justify-center gap-1.5 cursor-pointer ${
                activeTab === 'love-words'
                  ? 'bg-[#6B1724] text-white shadow-md'
                  : 'text-[#52453E] hover:text-[#1E1B18]'
              }`}
            >
        ...
        <div className="max-w-5xl mx-auto">
          ...
          {activeTab === 'love-words' && (
            ...
            >
              {/* Form Input Column */}
              <div className="lg:col-span-6 bg-white p-6 sm:p-8 rounded-3xl border border-[#E5D9C8] shadow-sm space-y-4">
                <div className="flex items-center gap-2 pb-3 border-b border-[#F0E6D8]">
                  <Wand2 className="w-4 h-4 text-[#C59A5D]" />
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="block text-xs font-semibold text-[#52453E] uppercase tracking-wider mb-1">
                      Partner's Name
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full px-3.5 py-2.5 rounded-xl border border-[#DFCDB7] bg-[#FCFAF7] text-sm focus:outline-none focus:border-[#6B1724]"
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-semibold text-[#52453E] uppercase tracking-wider mb-1">
                ...
                <div>
                  <div className="flex items-center justify-between mb-1">
                    <label className="block text-xs font-semibold text-[#52453E] uppercase tracking-wider">
                  ...
                  <div className="flex flex-wrap gap-1.5 mb-2">
                    {TARGET_NEIGHBORHOODS.map((nh) => (
                      <button
                        ...
                        className="text-[10px] px-2 py-0.5 rounded-full bg-[#FAF5EE] hover:bg-[#FAF0E1] border border-[#DFCDB7] text-[#6B1724] font-medium transition-colors cursor-pointer"
                      >
                  ...
                  <textarea
                    ...
                    className="w-full px-3.5 py-2 rounded-xl border border-[#DFCDB7] bg-[#FCFAF7] text-xs focus:outline-none focus:border-[#6B1724] resize-none"
                  />
                </div>
                ...
                >
                  {isGeneratingLetter ? (
                    <>
                      <Sparkles className="w-4 h-4 animate-spin text-[#DFB776]" />
                      <span>Composing Bespoke Romantic Words...</span>
                    </>
                  ) : (
                    <>
                      <Wand2 className="w-4 h-4 text-[#DFB776]" />
              ...
              <div className="lg:col-span-6">
                <div className="bg-[#FAF4EC] rounded-3xl p-6 sm:p-8 border-2 border-[#DFCDB7] shadow-xl relative min-h-[460px] flex flex-col justify-between">
                  {/* Wax Seal Monogram Badge */}
                  <div className="absolute -top-4 right-6 w-12 h-12 rounded-full bg-[#6B1724] border-2 border-[#DFB776] shadow-md flex items-center justify-center text-white">
                    <Heart className="w-5 h-5 fill-[#DFB776] text-[#DFB776]" />
                  </div>

                  <div>
                    <div className="flex items-center gap-2 text-xs uppercase tracking-widest font-semibold text-[#8C6D46] mb-4 pb-2 border-b border-[#E8DAC6]">
                      <Scroll className="w-4 h-4 text-[#C59A5D]" />
                      <span>Vintage Keepsake Parchment Preview</span>
                    </div>

                    {isGeneratingLetter ? (
                      <div className="py-16 text-center space-y-3">
                        <Sparkles className="w-8 h-8 text-[#C59A5D] animate-spin mx-auto" />
                        <p className="text-sm font-cursive text-2xl text-[#6B1724]">
                          Weaving your love memories into poetry...
                        </p>
                        <p className="text-xs text-[#736359]">
                          Gemini 3.7 Flash Romantic Architecture Engine
                        </p>
                      </div>
                    ) : generatedLetter ? (
                      <div className="space-y-4">
                        <div className="font-serif-display text-sm sm:text-base text-[#2E2824] leading-relaxed whitespace-pre-line italic bg-[#F5ECE1]/60 p-5 rounded-2xl border border-[#DFCDB7]">
                          "{generatedLetter}"
                        </div>
                      </div>
                    ) : (
                      <div className="py-16 text-center space-y-3 text-[#736359]">
                        <Scroll className="w-12 h-12 text-[#DFCDB7] mx-auto" />
                        <h4 className="font-serif-display text-lg font-bold text-[#1E1B18]">
                          Your Custom Letter Will Appear Here
                        </h4>
                        <p className="text-xs max-w-xs mx-auto text-[#52453E]">
                  ...
                  {generatedLetter && (
                    <div className="pt-4 border-t border-[#E8DAC6] flex flex-wrap items-center justify-between gap-3 mt-4">
                      <button
                        onClick={handleCopyLetter}
                        className="px-4 py-2 rounded-full bg-white border border-[#DFCDB7] text-xs font-semibold text-[#1E1B18] flex items-center gap-1.5 cursor-pointer hover:bg-[#FAF0E1] transition-colors"
                      >
                        {isCopied ? (
                          <>
                          ...
                          <>
                            <Copy className="w-3.5 h-3.5 text-[#8C6D46]" />
          ...
          {activeTab === 'surprise-itinerary' && (
            ...
            >
              {/* Form Input Column */}
              <div className="lg:col-span-5 bg-white p-6 sm:p-8 rounded-3xl border border-[#E5D9C8] shadow-sm space-y-4">
                <div className="flex items-center gap-2 pb-3 border-b border-[#F0E6D8]">
                  <Clock className="w-4 h-4 text-[#C59A5D]" />
                  <h3 className="font-serif-display text-lg font-bold text-[#1E1B18]">
              ...
              <div className="lg:col-span-7">
                <div className="bg-white rounded-3xl p-6 sm:p-8 border border-[#E5D9C8] shadow-md min-h-[460px]">
                  <div className="flex items-center justify-between pb-4 border-b border-[#F0E6D8] mb-6">
                    <div>
                    ...
                    <span className="px-3 py-1 rounded-full bg-[#FAF0E1] text-[#6B1724] font-semibold text-xs border border-[#DFCDB7]">
                      100% Private
                    </span>
                  </div>
                  ...
                  {isGeneratingTimeline ? (
                    <div className="py-20 text-center space-y-3">
                      <Sparkles className="w-8 h-8 text-[#C59A5D] animate-spin mx-auto" />
                      <p className="font-cursive text-2xl text-[#6B1724]">
                    ...
                    <div className="space-y-6">
                      {/* Timeline Items */}
                      <div className="space-y-4 relative before:absolute before:top-3 before:bottom-3 before:left-[19px] before:w-0.5 before:bg-[#E5D9C8]">
                        {generatedTimeline.map((item, idx) => (
                          <div key={idx} className="relative flex items-start gap-4">
                            <div className="w-10 h-10 rounded-full bg-[#FAF0E1] border-2 border-[#6B1724] flex items-center justify-center text-[#6B1724] font-bold text-xs shrink-0 shadow-xs z-10">
                              {idx + 1}
                            </div>
                            <div className="bg-[#FAF7F2] p-4 rounded-2xl border border-[#DFCDB7] flex-1">
                              <div className="flex flex-wrap items-center justify-between gap-1 mb-1">
                                <span className="font-serif-display font-bold text-[#1E1B18] text-sm">
                                  {item.phase}
                                </span>
                                <span className="text-xs font-mono font-bold text-[#6B1724] bg-white px-2 py-0.5 rounded-md border border-[#DFCDB7]">
                                  {item.time}
                                </span>
                              </div>
                      ...
                      {curatorAdvice && (
                        <div className="p-4 rounded-2xl bg-[#F5ECE1] border border-[#DFCDB7] flex items-start gap-3">
                          <Star className="w-4 h-4 text-[#C59A5D] shrink-0 mt-0.5" />
                          <div className="text-xs text-[#2E2824]">
                            <strong className="font-semibold text-[#1E1B18]">Director's Secret Touch: </strong>
                            {curatorAdvice}
                          </div>
                        </div>
                      )}
                      ...
                      {recommendedSongs.length > 0 && (
                        <div className="pt-3 border-t border-[#F0E6D8]">
                          <div className="flex items-center gap-2 text-xs font-semibold text-[#8C6D46] uppercase tracking-wider mb-2">
                            <Music className="w-3.5 h-3.5 text-[#C59A5D]" />
                            <span>Recommended Background Melodies</span>
                          </div>
                          <div className="flex flex-wrap gap-2">
                            {recommendedSongs.map((song, i) => (
                              <span key={i} className="text-xs px-3 py-1 bg-[#FAF0E1] text-[#6B1724] rounded-full border border-[#DFCDB7]">
                                🎵 {song}
                              </span>
                            ))}
                          </div>
                    ...
                    <div className="py-20 text-center space-y-3 text-[#736359]">
                      <Clock className="w-12 h-12 text-[#DFCDB7] mx-auto" />
                      <h5 className="font-serif-display text-lg font-bold text-[#1E1B18]">
          ...
          {activeTab === 'vibe-matcher' && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.4 }}
              className="bg-white rounded-3xl p-6 sm:p-10 border border-[#E5D9C8] shadow-md max-w-3xl mx-auto"
            >
              {!vibeMatchResult ? (
                <div className="space-y-6">
                  <div className="text-center pb-4 border-b border-[#F0E6D8]">
                    <span className="text-xs font-semibold uppercase tracking-widest text-[#8C6D46]">
                      Questionnaire • Step {quizStep} of 4
                    </span>
                    <h3 className="font-serif-display text-2xl font-bold text-[#1E1B18] mt-1">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                      {[
                        ...
                        <button
                          ...
                          className="p-5 rounded-2xl border border-[#DFCDB7] bg-[#FCFAF7] hover:bg-[#FAF0E1] hover:border-[#6B1724] text-left transition-all cursor-pointer group"
                        >
                          <div className="text-2xl mb-2">{opt.icon}</div>
                          <div className="font-serif-display font-bold text-sm text-[#1E1B18] group-hover:text-[#6B1724]">
                            {opt.title}
                          </div>
                          <div className="text-xs text-[#52453E] mt-1">
                            {opt.label}
                          </div>
                        </button>
                      ))}
                    ...
                    <div className="space-y-4">
                          ...
                          <button
                            ...
                            className={`p-5 rounded-2xl border text-left transition-all cursor-pointer group ${
                              quizAnswers.favoriteCuisine === opt.label
                                ? 'border-[#6B1724] bg-[#FAF0E1]'
                                : 'border-[#DFCDB7] bg-[#FCFAF7]'
                            }`}
                          >
                            <div className="text-2xl mb-2">{opt.icon}</div>
                            <div className="font-serif-display font-bold text-sm text-[#1E1B18]">
                              {opt.title}
                            </div>
                            <div className="text-xs text-[#52453E] mt-1">
                              {opt.label}
                      ...
                      <div className="flex justify-between items-center pt-4">
                        <button
                          ...
                          className="px-5 py-2.5 rounded-full border border-[#DFCDB7] text-xs font-semibold text-[#52453E] hover:bg-[#F5ECE1] cursor-pointer"
                        >
                          Back
                        </button>
                ...
                <div className="text-center space-y-6">
                  <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#FAF0E1] border border-[#DFCDB7] text-[#6B1724] text-xs font-bold uppercase tracking-widest">
                    <Sparkles className="w-3.5 h-3.5 text-[#C59A5D]" />
                    <span>Your Bespoke Match Found</span>
                  </div>

                  <h3 className="font-serif-display text-3xl sm:text-4xl font-bold text-[#1E1B18]">
                    {vibeMatchResult.matchName}
                  </h3>

                  <p className="text-sm text-[#52453E] max-w-xl mx-auto leading-relaxed italic bg-[#FCFAF7] p-5 rounded-2xl border border-[#DFCDB7]">
                    "{vibeMatchResult.matchReasoning}"
                  </p>

                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-left">
                    <div className="p-4 rounded-2xl bg-[#FAF7F2] border border-[#DFCDB7]">
                      <div className="text-xs uppercase font-semibold text-[#8C6D46] mb-1">Recommended Zone</div>
                      <div className="font-serif-display font-bold text-sm text-[#1E1B18]">
                    ...
                    <div className="p-4 rounded-2xl bg-[#FAF7F2] border border-[#DFCDB7]">
                      <div className="text-xs uppercase font-semibold text-[#8C6D46] mb-1">Curated Theme</div>
                      <div className="font-serif-display font-bold text-sm text-[#1E1B18]">
                    ...
                    <div className="p-4 rounded-2xl bg-[#FAF7F2] border border-[#DFCDB7]">
                      <div className="text-xs uppercase font-semibold text-[#8C6D46] mb-1">Dining Experience</div>
                      <div className="font-serif-display font-bold text-sm text-[#1E1B18]">
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-center gap-3.5 pt-4">
                    ...
                    <button
                      ...
                      className="w-full sm:w-auto px-6 py-3.5 rounded-full border border-[#DFCDB7] bg-white text-xs uppercase tracking-wider font-semibold text-[#52453E] hover:bg-[#F5ECE1] flex items-center justify-center gap-2 cursor-pointer"
                    >
          ...
          {activeTab === 'couple-seal' && (
            ...
            >
              ...
              <div className="lg:col-span-5 bg-white p-6 sm:p-8 rounded-3xl border border-[#E5D9C8] shadow-sm space-y-5">
                <div className="flex items-center gap-2 pb-3 border-b border-[#F0E6D8]">
                  <Crown className="w-4 h-4 text-[#C59A5D]" />
                  <h3 className="font-serif-display text-lg font-bold text-[#1E1B18]">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full text-center font-serif-display text-xl font-bold py-2 rounded-xl border border-[#DFCDB7] bg-[#FCFAF7] focus:outline-none focus:border-[#6B1724]"
                    />
                  </div>
                ...
                {/* Seal Style Selector */}
                <div>
                  <label className="block text-xs font-semibold text-[#52453E] uppercase tracking-wider mb-2">
                    ...
                    {[
                      ...
                      <button
                        ...
                        className={`p-3 rounded-xl border text-center transition-all cursor-pointer ${
                          monogramStyle === st.id
                            ? 'bg-[#FAF0E1] border-[#6B1724] text-[#6B1724] font-bold shadow-xs'
                            : 'bg-[#FCFAF7] border-[#DFCDB7] text-[#52453E] hover:bg-[#FAF5EE]'
                        }`}
                      >
                        <span className="text-xs block font-serif-display">{st.label}</span>
                        <span className="text-[10px] text-[#736359] block mt-0.5">{st.desc}</span>
                      </button>
                    ))}
                  </div>
                </div>
                ...
                <div className="p-3 bg-[#FAF0E1] rounded-xl border border-[#DFCDB7] flex items-center gap-2 text-xs text-[#6B1724]">
                  <Sparkles className="w-4 h-4 text-[#DFB776] shrink-0" />
                  <span>
              ...
              <div className="lg:col-span-7">
                <div className="bg-[#FAF4EC] rounded-3xl p-6 sm:p-10 border-2 border-[#DFCDB7] shadow-xl relative overflow-hidden flex flex-col items-center justify-between text-center">
                  {/* Decorative Border Frame */}
                  <div className="absolute inset-3 border border-[#DFCDB7] rounded-2xl pointer-events-none" />
                  <div className="absolute inset-5 border border-dashed border-[#DFCDB7]/60 rounded-xl pointer-events-none" />

                  {/* Corner Love Emblems */}
                  <span className="absolute top-6 left-6 text-sm text-[#DFB776]">✨</span>
                  <span className="absolute top-6 right-6 text-sm text-[#DFB776]">✨</span>
                  <span className="absolute bottom-6 left-6 text-sm text-[#DFB776]">💖</span>
                  <span className="absolute bottom-6 right-6 text-sm text-[#DFB776]">💖</span>

                  {/* Header */}
                  <div className="relative z-10 pt-2 pb-4">
                    <span className="text-[10px] uppercase font-bold tracking-[0.25em] text-[#8C6D46] block mb-1">
                      Mumbai Moments • Private Estate Sanctum
                    </span>
                    <h4 className="font-serif-display text-xl sm:text-2xl font-bold text-[#1E1B18]">
                  ...
                  <div className="relative z-10 my-6">
                    <div className="w-36 h-36 sm:w-44 sm:h-44 rounded-full bg-linear-to-br from-[#6B1724] via-[#831D2D] to-[#4A0E18] border-4 border-[#DFB776] shadow-2xl flex flex-col items-center justify-center text-white relative group">
                      {/* Outer Ring Sparkles */}
                      <div className="absolute -top-3 w-8 h-8 rounded-full bg-[#DFB776] text-[#1E1B18] flex items-center justify-center text-xs shadow-md">
                        {monogramStyle === 'royal-gold' ? '👑' : monogramStyle === 'infinity-knot' ? '♾️' : '🌹'}
                      </div>

                      {/* Initials with Infinity Knot / Heart */}
                      <div className="flex items-center justify-center gap-1">
                        <span className="font-serif-display text-4xl sm:text-5xl font-bold text-[#FAF0E1] drop-shadow-md">
                          {monogramInitials.p1}
                        </span>
                        <div className="flex flex-col items-center">
                          <Heart className="w-4 h-4 fill-[#DFB776] text-[#DFB776] animate-pulse" />
                          <span className="text-[10px] text-[#DFB776] font-bold">&</span>
                        </div>
                        <span className="font-serif-display text-4xl sm:text-5xl font-bold text-[#FAF0E1] drop-shadow-md">
                          {monogramInitials.p2}
                        </span>
                      ...
                      <span className="text-[8px] uppercase tracking-[0.2em] text-[#DFB776] mt-1 font-semibold">
                        Pali Hill • Mumbai
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="relative z-10 max-w-md mx-auto space-y-2 mb-6">
                    <p className="font-serif-display text-sm sm:text-base text-[#2E2824] italic leading-relaxed">
                      "{customVowKeepsake}"
                    </p>
                    <span className="text-[11px] text-[#736359] block">
                      Dedicated exclusively to {monogramInitials.p1} & {monogramInitials.p2}
                    </span>
                  </div>

                  {/* Action Buttons */}
                  <div className="relative z-10 w-full pt-4 border-t border-[#E5D9C8] flex flex-wrap items-center justify-center gap-3">
                    <button
                      onClick={() => {
                      ...
                      className="px-5 py-2.5 rounded-full bg-white border border-[#DFCDB7] text-xs font-semibold text-[#1E1B18] hover:bg-[#FAF0E1] flex items-center gap-1.5 cursor-pointer shadow-xs"
                    >
                      {isKeepsakeCopied ? (
                        <>
                          <Check className="w-3.5 h-3.5 text-emerald-600" />
