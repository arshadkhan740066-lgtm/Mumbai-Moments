...
export const EstateOverviewSection = ({
  ...
  return (
    <section id="estate-overview" className="py-16 sm:py-24 bg-[#FAF5EE] border-b border-[#E5D9C8]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center mb-16">
          ...
          <div className="lg:col-span-6 grid grid-cols-2 gap-4">
            <div className="space-y-4">
              <div className="rounded-3xl overflow-hidden shadow-lg border border-[#E5D9C8] aspect-[4/5] bg-[#FAF7F2]">
                <img
              ...
              <div className="p-4 rounded-2xl bg-white border border-[#E5D9C8] text-center shadow-xs">
                <span className="text-[10px] uppercase font-bold text-[#8C6D46] tracking-wider block">
                  Location
                </span>
                <span className="text-xs font-bold text-[#1E1B18]">Pali Hill, Bandra West</span>
              </div>
            </div>
            ...
            <div className="space-y-4 pt-6">
              <div className="p-4 rounded-2xl bg-white border border-[#E5D9C8] text-center shadow-xs">
                ...
                <span className="text-xs font-bold text-[#6B1724]">Only 1 Booking Per Slot</span>
              </div>
              <div className="rounded-3xl overflow-hidden shadow-lg border border-[#E5D9C8] aspect-[4/5] bg-[#FAF7F2]">
                <img
          ...
          <div className="lg:col-span-6 space-y-6">
            <div className="inline-flex items-center gap-1.5 text-xs text-[#8C6D46] font-semibold uppercase tracking-wider">
              <MapPin className="w-4 h-4 text-[#C59A5D]" />
              <span>Pali Hill Sanctuary • Bandra West</span>
            </div>

            <h3 className="font-serif-display text-2xl sm:text-4xl font-bold text-[#1E1B18] leading-tight">
              A private luxury canvas with five-star hospitality
            </h3>

            <p className="text-sm text-[#52453E] font-light leading-relaxed">
            ...
            <div className="space-y-3 pt-2">
              <span className="text-xs uppercase tracking-widest text-[#6B1724] font-bold block">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                {VENUE_PROPERTY_INFO.inclusionsStandard.map((inc, i) => (
                  <div
                    key={i}
                    className="p-3 rounded-2xl bg-white border border-[#E5D9C8] flex items-start gap-2.5 shadow-xs"
                  >
